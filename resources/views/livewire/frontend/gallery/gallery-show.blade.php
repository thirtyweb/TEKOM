        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 md:mb-12">
                ...
                <nav class="font-mono text-sm text-gray-500 mb-4">
                    <a href="{{ route('home') }}" class="hover:text-green-300 transition-colors">/home</a>
                    <span class="text-gray-600">/</span>
                    <a href="{{ route('gallery.index') }}" class="hover:text-green-300 transition-colors">visual_archives</a>
                    <span class="text-gray-600">/</span>
                    ...
                    @foreach($gallery->images as $index => $image)
                        ...
                        <div class="group relative aspect-square overflow-hidden rounded-md border border-green-500/20 bg-gray-900/40 p-1 transition-all duration-300 hover:border-green-500/60 cursor-pointer"
                            ...
                            <img src="{{ asset('storage/' . $image) }}" 
                                 ...
                                 class="w-full h-full object-cover transition-all duration-500 filter grayscale group-hover:grayscale-0 group-hover:scale-105">
